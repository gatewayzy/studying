 ...
 */
public class _02volatile  extends Object implements Runnable {
    private int value;
    private volatile boolean missedIt;  //missedIt变量被标记为volatile
    private long creationTime;  //creationTime不需要声明为volatile，因为代码执行中它没有发生变化
    ...
    */
    ...
    public static void main(String[] args) {
        try {
            ...
            _02volatile vol = new _02volatile();
