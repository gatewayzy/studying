...
/**
 * 使用dom4j对xml文件进行crud操作<br>
 * dom4j属于非sun公司对dom技术的实现，比dom提高内存使用效率，又可以进行crud操作
 *
 */
public class XMLDom4j {
	...
	public static void main(String[] args) throws Exception {
		...
		// 2指定解析哪个xml文件
		Document document = saxReader.read(new File("src/main/resources/files/xml/myclasses3.xml"));
	...
	public static void addByIndex(Document document) throws Exception {
		...
		XMLWriter writer = new XMLWriter(new FileOutputStream(new File(
				"src/main/resources/files/xml/myclasses3.xml")), output);
