package com.bebetter.mybatisdemo.controller;

import com.bebetter.Application;
import com.bebetter.mybatisdemo.dao.UserDao;
...
@SpringBootTest(classes = {Application.class}) //默认的classes，可省略也可使用指定的类
